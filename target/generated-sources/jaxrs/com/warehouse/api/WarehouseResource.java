...
public interface WarehouseResource {
  ...
  @GET
  @Produces("application/json")
  List<Warehouse> searchAndFilterWarehouses(@QueryParam("location") String location,
      ...
      @QueryParam("pageSize") @DecimalMax(value = "100", inclusive = true) @DefaultValue("10") BigInteger pageSize);
}
